				...
				<div class="card-body chat-body">
					<div class="chat-box">
						...
						<div class="chat-left-aside">
							<div class="media">
								<img class="rounded-circle user-image" src="/storage/{{@Auth::User()->profile->image}}" alt="{{asset('assets/images/user/12.png')}}" alt="">
								<div class="about">
						...
						<div class="col pe-0 chat-right-aside">
							...
							<div class="chat">
								...
								<div class="chat-header clearfix">
									<img class="rounded-circle" id="chat_image" src="{{asset('assets/images/user/8.jpg')}}" alt="">
									<div class="about">
...
<script>
	...
	const myMessage = (message,time) => $(`<li class="clearfix"><div class="message my-message pull-right bg-light mb-0">
												<img class="rounded-circle float-start chat-user-img img-30" src="/storage/{{@Auth::User()->profile->image}}" alt="">
