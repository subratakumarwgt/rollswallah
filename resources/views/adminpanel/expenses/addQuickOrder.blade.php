        ...
        <div class="card-body table-responsive">
          <div class="row">
            ...
            <div class="col-md-3 mb-3">
              <div class="input-group">
                ...
                <input class="form-control" type="text" minlength="10" max="9999999999" placeholder="(+91) Contact number (mandatory)" data-bs-original-title="" title="" id="user_contact" value="{{@$order->user_contact}}" required>
              </div>
            </div>
            <div class="col-md-3 mb-3">
              <div class="input-group">
          ...
          <table class="table" id="quick_order_table">
            ...
            <tbody id="charge_body">
              ...
              <tr id="charge_row{{$key > 0 ? $key : '' }}" class="charges_row">
                <td colspan="2">
                  <select name="item_name" id="charges{{$key > 0 ? $key : '' }}" class="form-control item_name charges">
