          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-4">
              <div class="input-group" id="user_contact_group">
                ...
                <input class="form-control" type="text" minlength="10" max="9999999999" placeholder="Contact number (mandatory)" data-bs-original-title="" title="" id="user_contact" value="{{@$order->user_contact}}" required>
              </div>
            </div>
            <div class="col-md-4 mb-4">
