						...
						<img src="/{{$product->varient->image ?? 'storage/productimage/productdefault.png'}}" class="img-fluid " id="img_prv">
                            ...
                            <form id="product_form">
                                ...
                                <div class="mb-3">
									...
									<select class="form-control" id="varient_of" name="varient_of" >
										@if(!empty($product->varient))
										<option value="{{$product->varient->id}}">{{$product->varient->short_name}}</option>
										@endif
									</select>
								</div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
									...
									<select class="form-control" id="varient_type" name="varient_type" >
                                        ...
                                        <option value="{{$varient_type}}" @if($product->varient_type == $varient_type) selected @endif>{{$varient_type}}</option>
                                        @endforeach
									</select>
								</div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
									...
									<input type="text" class="form-control" name="varient_type_desc" value="{{$product->varient_type_desc}}" id="varient_type_desc"> 
								</div>
                            </div>
                                <div class="col-md-12">
                                <div class="mb-3">
							...
							<div class="col-sm-6 col-md-3">
								<div class="mb-3">
									...
									<input class="form-control" type="number" placeholder="Offer Price " data-bs-original-title="" title="" required id="agent_price" value="{{@$product->agent_price}}">
								</div>
							</div>
                            <div class="col-sm-6 col-md-3">
								<div class="mb-3">
                            ...
                            <div class="col-sm-6 col-md-4">
								<div class="mb-3">
									...
									<select class='form-control' id="size">
                                        ...
                                        <option value="{{$size}}" @if($product->size == $size) selected @endif>{{$size}}</option>
                                        @endforeach
                                    </select>
								</div>
							</div>
