                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" type="text" minlength="10" max="9999999999" placeholder="Contact number" data-bs-original-title="" title="" id="contact" value="{{@$doctor->name}}" required>
                                        </div>
                                    </div>
