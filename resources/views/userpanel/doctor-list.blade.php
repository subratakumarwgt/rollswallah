                        ...
                        <div class="col-md-6">
                            <div class="">
                                ...
                                <div class="text-center profile-details">
                                    <h4 class="text-primary"><a href="/doctor/{{$doctor->id}}">Dr. {{strtoupper($doctor->name)}} <small><i class="fas fa-share-square"></i></small></a></h4>
                                    <h6 class="text-secondary">{{strtoupper($doctor->specialist)}}</h6>
                                </div>
                                <div class="card-footer row">
                                    <div class="col-4 col-sm-4">
                                        <h6>Exp.</h6>
                                        <h5><span class="badge badge-light text-primary">{{$doctor->experience}} years</span></h5>
                                    </div>
                                    <div class="col-4 col-sm-4">
                                        <h6>Patients</h6>
                                    ...
                                    <div class="col-4 col-sm-4">
                                        <h6>Visits</h6>
                                        <h5><span class="badge badge-light text-primary">{{$doctor->visit_frequency}}</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="owl-carousel owl-theme owl-carousel-15" id="">
                                        ...
                                        <div class="item">
                                            <h5>
                                                <div class="badge badge-light text-primary badge-pill  ">{{date('l, d M',strtotime($slot->date))}} </div>
                                            </h5>
                                        </div>
                                        @endforeach
                                    </div>
                                    <div class="row p-3 justify-content-center">
                                        <input class="doctor_details" id="{{$doctor->id}}_details" type="hidden" value="{{json_encode(['doctor'=>$doctor,'centre'=>$centre,'timming'=>json_decode($doctor->visits->others_json),'slots'=>$doctor->slots,'user'=>@Auth::User()])}}">
