<div class="page-header close_icon">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="{{route('/')}}"><img class="img-fluid" src="{{asset('assets/images/logo/logo.jpg')}}" alt="" width="100px"></a></div>
      <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
    </div>
    <div class="left-header col horizontal-wrapper ps-0">
      <ul class="horizontal-menu">
      <a href="{{'/'}}"><img class="img-fluid" src="{{asset('assets/images/logo/logo.png')}}" width="100px" alt=""></a>
      ...
      <ul class="nav-menus">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown onhover-show-div" style="overflow-y: scroll;overflow-x: none;max-height: 550px !important">
            ...
            <li><a class="btn btn-block w-100 mb-2 btn-primary view-cart" href="{{ route('cart-items') }}">Go to shoping bag</a><a class="btn btn-block w-100 btn-secondary view-cart" href="{{ route('checkout') }}">Checkout</a></li>
          </ul>
        </li>
