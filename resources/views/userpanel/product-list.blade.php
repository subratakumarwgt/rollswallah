                           ...
                           <div class="modal-content" id="modal_content_{{$product->id}}">
                            ...
                            <del class="text-danger" id="pre_price_{{$product->id}}"> MRP: <i class="fa fa-inr"></i>{{$product->pre_price}}</del>
                                       ...
                                       <div class="product-size">
                                         @if(!empty($product->varients->count()))
                                        <h6>Available Varieties</h6>
                                         <ul>
   <li class="mb-2 "> <button class="btn btn-outline-success shadow-sm active varient_type" data-product = "{{$product->id}}" data-varient = "{{$product->id}}" type="button" data-bs-original-title="" title="" >{{$product->varient_type_desc}}  </button> </li>
                                          @foreach($product->varients as $var)
                                         <li class=" mb-2"> 
                     <button class="btn btn-outline-success shadow-sm varient_type" type="button" data-bs-original-title="" title="" 
                     data-product = "{{$product->id}}" data-varient = "{{$var->id}}" >{{$var->varient_type_desc}}</button>
                                             </li>
