    ...
    <div class="page-wrapper landing-page">
      ...
      <section class="section-space cuba-demo-section layout " id="layout">
        <div class="container">
          ...
          <div class="item">
          <div class="img-wrapper-rounded shadow-sm border-bottom border-primary"><div class="ribbon ribbon-danger ribbon-left"> - <i class="fa fa-inr small"></i> 19</div><img src="<?php echo e(asset('assets/images/product/1.png')); ?>" alt="" class="img-height-200"></div>
        ...
        <div class="item">
          <div class="img-wrapper-rounded shadow border-bottom border-primary"><div class="ribbon ribbon-danger ribbon-left"> - <i class="fa fa-inr small"></i> 25</div><img src="<?php echo e(asset('assets/images/product/1.png')); ?>" alt="" class="img-height-200"></div>
          <div class="h6 text-center">BRU COFFEE GOLD</div>
          <div class=" text-success small text-center border border-success rounded bg-white"><i class="fa fa-inr small"></i> 200
            <del class="text-danger"><small> </small><i class="fa fa-inr small"></i>220 </del> 
          </div>
        ...
        <div class="item">
          <div class="img-wrapper-rounded shadow border-bottom border-primary"><div class="ribbon ribbon-danger ribbon-left"> - <i class="fa fa-inr small"></i> 5</div><img src="<?php echo e(asset('assets/images/product/1.png')); ?>" alt="" class="img-height-200"></div>
          <div class="h6 text-center">BRU COFFEE GOLD</div>
          <div class=" text-success small text-center border border-success rounded bg-white"><i class="fa fa-inr small"></i> 200
            <del class="text-danger"><small> </small><i class="fa fa-inr small"></i>220 </del> 
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 wow pulse">
              ...
              <div class="owl-carousel owl-theme owl-carousel-deal" id="owl-carousel-12">
          <div class="item">
          <div class="img-wrapper-rounded shadow border-bottom border-primary"><div class="ribbon ribbon-danger ribbon-left"> - <i class="fa fa-inr small"></i> 19</div><img src="<?php echo e(asset('assets/images/product/1.png')); ?>" alt="" class="img-height-200"></div>
          <div class="h6 text-center">BRU COFFEE GOLD</div>
          <div class=" text-success small text-center border border-success rounded bg-white"><i class="fa fa-inr small"></i> 200
            <del class="text-danger"><small> </small><i class="fa fa-inr small"></i>220 </del> 
          </div>                   
