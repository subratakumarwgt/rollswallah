  ...
  <body class="landing-page">
    ...
    <div class="page-wrapper landing-page">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-8">                 
              <div class="wow fadeIn"><img class="screen1" src="<?php echo e(asset('assets/images/rollsbg1.png')); ?>" alt=""></div>
      ...
      <div class="row justify-content-center p-3 ">
                    <!-- <img src="<?php echo e(asset('assets/images/icecreambg1.png')); ?>" alt=""> -->
                    <h3 class="text-center m-3 h2 wow fade-in">Our Top Selling Ice cream Rolls</h3>
                    <img src="<?php echo e(asset('posters/1.png')); ?>" alt="" class="col-md-3">
                    <img src="<?php echo e(asset('posters/2.png')); ?>" alt="" class="col-md-3">
                    <img src="<?php echo e(asset('posters/3.png')); ?>" alt="" class="col-md-3">
                    <img src="<?php echo e(asset('posters/4.png')); ?>" alt="" class="col-md-3">
                  </div>
