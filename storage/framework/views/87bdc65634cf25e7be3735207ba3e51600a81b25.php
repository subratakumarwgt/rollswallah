                  ...
                  <div class="row justify-content-center"> 
                    <div class="col-md-4 mb-2 ">
                      <div class="border p-3 text-center rounded border-primary bg-light text-primary shadows-sm">
                        <strong>Date</strong> : <span class="text-dark editable_value"> <?php echo e(date("Y-m-d")); ?> </span> <i class="fa fa-pencil small text-danger cursor-pointer link" onclick="editHandler(this)"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\rollswallah\resources\views/adminpanel/expenses/addDailyExpense.blade.php ENDPATH**/ ?>