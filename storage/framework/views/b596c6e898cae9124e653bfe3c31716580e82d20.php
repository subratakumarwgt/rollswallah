...
<script>
	...
	const sendMessage = async (message) => { 
     ...
     return ((this.getHours() < 10)?"0":"") + this.getHours() +":"+ ((this.getMinutes() < 10)?"0":"") + this.getMinutes() +":"+ ((this.getSeconds() < 10)?"0":"") + this.getSeconds();
		...
		console.log(echo)
	let sender =	echo.pusher.global_emitter.prototype.emit("App\\Events\\sendChat",{ "message":message },"moredata")
	console.log(sender)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\alliswell\Cuba\resources\views/adminpanel/chats/chat.blade.php ENDPATH**/ ?>