     ...
     $("#password_submit").on('click', function(e) {
        ...
        if (password_valid) {
            ...
            $.ajax(settings).done(function(response) {
                ...
                window.open("/management/user/edit/"+$("#user_id").val(), "_self");
            });
        }
     });
</script>
    ...
    $("#submit").on('click', function(e) {
        ...
        if (account_valid == true && profile_valid == true && address_valid == true) {
            ...
            $.ajax(settings).done(function(response) {
                ...
                window.open("/profile-password", "_self");
            });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('userpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\alliswell\Cuba\resources\views/userpanel/profilepassword.blade.php ENDPATH**/ ?>