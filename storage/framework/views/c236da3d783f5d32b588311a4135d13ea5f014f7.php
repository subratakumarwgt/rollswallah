          ...
          <div class="p-3">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                ...
                <span class="badge badge-dark badge-xl"><strong><i class="fa fa-inr"></i><text id="final_total"><?php echo e(@$charges->packing_charge + @$charges->delivery_charge + @$subtotal); ?></text> </strong></span>
              </li>
            </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('userpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\alliswell\Cuba\resources\views/userpanel/cart.blade.php ENDPATH**/ ?>