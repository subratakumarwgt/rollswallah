                    ...
                    <div>
                      <nav class="navbar navbar-expand-md p-0">
                        <form class="form-inline">
                          <div class="mb-3">
                            <select class="btn form-select b-light digits" id="n-columns">
                    ...
                    <div class="tab-pane fade show active" id="pills-input" role="tabpanel" aria-labelledby="pills-input-tab">
                      <form class="theme-form">
                        ...
                        <div class="mb-3 draggable">
                          ...
                          <select class="form-select btn-square" id="select-1">
                    ...
                    <div class="tab-pane fade" id="pills-select" role="tabpanel" aria-labelledby="pills-select-tab">
                      <form class="theme-form">
                        <div class="mb-3 draggable">
                          ...
                          <select class="form-select btn-square" id="formcontrol-select1">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                        ...
                        <div class="mb-3 draggable">
                          ...
                          <select class="form-select btn-square" id="formcontrol-select2" multiple="">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\projects\rollswallah\resources\views/builders/form-builder-2.blade.php ENDPATH**/ ?>