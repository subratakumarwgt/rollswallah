...
<h3>Add New Doctor <i class="fas fa-user-md"></i></h3>
<?php $__env->stopSection(); ?>
			...
			<div class="card">
				...
				<div class="card-body">
					<form class="f1" method="post" enctype="multipart/form-data" action="/management/doctor/import/data" id="doctor_form">
						...
						<fieldset>
                        <div class="row">
                            <div class="col-md-3"> <img class="img-fluid mt-3 shadow" src="/storage/centreimage/w2ZjWdXhNmGL4lWDf0ymV3IuO4XNqaitykFd4syt.png" id="img_prv"></div>
                            <div class="col-md-9">
                                <div class="row">
                                <div class="col-md-6">
								<div class="mb-3">
									...
									<div class="input-group mb-3">
										...
										<input class="form-control" type="text" placeholder="Doctor's Full Name" data-bs-original-title="" title="" id="name" value="<?php echo e(@$doctor->name); ?>">
									</div>
								</div>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="mb-3">
									...
									<input class="form-control" type="text" placeholder="full fees" data-bs-original-title="" title="" id="full_charge" value="<?php echo e(@$doctor->full_charge); ?>">
								</div>
							</div>
							<div class="col-sm-6 col-md-6">
								<div class="mb-3">
									<label class="form-label">Fees <i class="fa fa-inr"></i> (advance charge)</label>
									<input class="form-control" type="text" placeholder="advance/booking fees" data-bs-original-title="" title="" id="booking_charge" value="<?php echo e(@$doctor->booking_charge); ?>">
								</div>
							</div>
                        ...
                        <div class="row">
							<div class="col-md-5">
								<div class="mb-3">
									...
									<input class="form-control" type="text" placeholder="Specialist" data-bs-original-title="" title="" id="specialist">
								</div>
							</div>
							<div class="col-sm-6 col-md-4">
								<div class="mb-3">
									<label class="form-label">Experience( in years. eg: 2)</label>
                                    <input class="form-control" type="text" placeholder="Experience( in years. eg: 2)" data-bs-original-title="" title="" id="experience">
								</div>
							</div>
                            ...
                            <div class="col-sm-6 col-md-12">
								<div class="mb-3">
									...
									<select class="form-control btn-square degrees" multiple="multiple" id="degree_json">
										...
										<option value="mphil">M. Phils.</option>
							...
							<div class="col-md-12 mb-2">
								<div>
									...
									<textarea class="form-control" rows="5" placeholder="Enter About your description" id="medical_history"></textarea>
								</div>
							</div>
						</div>
							<div class="f1-buttons">
                        ...
                        <div class="col-sm-6 col-md-4">
							...
							<div class="col-sm-6 col-md-4">
								<div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" max="30" placeholder="how many times ?(eg: 2)" data-bs-original-title="" title="" id="count">
								</div>
							</div>
                            <div class="col-sm-6 col-md-4">
								<div class="mb-3">
									<label class="form-label">Visit Type <small>(Weeks, Weekdays or Specific Dates)</small></label>
                                    <select class="form-control btn-square " id="type">
                                    <option value="week_nos">Week No(s)</option>
                            ...
                            <div class="col-sm-6 col-md-4">
								<div class="mb-3">
									...
									<select class="form-control btn-square week_day" multiple="multiple" id="week_days">
                                    <option value="">--null--</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group date" id="dt-time" data-target-input="nearest">
										<input class="form-control datetimepicker-input digits" type="text" data-target="#dt-time" data-bs-original-title="" title="" id="from_time">
                                   ...
                                   <div class="input-group date" id="dt-time2" data-target-input="nearest">
										<input class="form-control datetimepicker-input digits" type="text" data-target="#dt-time2" data-bs-original-title="" title="" id="to_time">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\alliswell\Cuba\resources\views/adminpanel/doctors/doctorimport.blade.php ENDPATH**/ ?>