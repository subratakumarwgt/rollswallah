            ...
            <div class="card-body">
                <div class="row text-center justify-content-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                        ...
                        <span class="text-muted ">(*Upload Excel Sheet in Given format) (*Max Size 5MB)<br> <a href="/excel_files/yepmember_excel.xlsx" class="btn btn-rounded btn-light pull-right ml-3 " download="yepmember_excel.xlsx">Download Sample Format</a></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminpanel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\subra\Documents\Projects\alliswell\Cuba\resources\views/adminpanel/contacts/contactimport.blade.php ENDPATH**/ ?>